<template>
    ...
    <view :style="$theme.pageStyle">
        ...
        <view class="item text-nr flex justify-between">
            ...
            <!-- #endif -->
            <!-- #ifndef MP-WEIXIN -->
            <u-button @click="showMobilePop = true" size="mini" type="primary" shape="circle">
                {{ userInfo?.mobile == '' ? '绑定手机号' : '更换手机号' }}
            </u-button>
            <!-- #endif -->
        </view>
...
const chooseAvatar = (e: any) => {
    ...
    // #ifndef MP-WEIXIN
    router.navigateTo('/uni_modules/vk-uview-ui/components/u-avatar-cropper/u-avatar-cropper?destWidth=300&rectWidth=200&fileType=jpg')
    // #endif
    // #ifdef MP-WEIXIN
