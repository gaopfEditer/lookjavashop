...
public class RequestUtils {
    ...
    public static String uri() {
        if (StringUtils.isNotNull(YmlUtils.get("like.url"))) {
            String domain = YmlUtils.get("like.url");
    ...
    public static String domain() {
        if (StringUtils.isNotNull(YmlUtils.get("like.url"))) {
            ...
            if (request != null) {
                ...
                String agree = "http:";
                if (request.getServerPort() == 443 || requestUrl.startsWith("https://")) {
                    agree = "https:";
                }

                if (!Arrays.asList(443, 80, 0).contains(RequestUtils.port())) {
                    return agree + "//" + urls.get(2);
                }
