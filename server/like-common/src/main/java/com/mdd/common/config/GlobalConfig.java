...
public class GlobalConfig {
    ...
    // Redis键前缀
    public static String redisPrefix = "java:b2c:";
    ...
    // 产品编码
    public static String productCode = "928846e8a106368169ca363872fa5f13";

    // 产品校验域名
    public static String productUrl = "https://server.likeshop.cn";
